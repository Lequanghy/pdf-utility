...
async def compress_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        # Option 1: Use Ghostscript (best quality/size trade-off)
        ...
        # Option 2: Alternative using pikepdf (lighter, but less aggressive)
        # import pikepdf
        # with pikepdf.open(input_pdf) as pdf:
        #     pdf.remove_unreferenced_resources()
        #     compressed_content = pdf.save(compress_streams=True)
